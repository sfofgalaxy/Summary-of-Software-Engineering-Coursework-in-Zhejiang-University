...
static void DisplayRect(double x0, double y0, double x1, double y1);
static void RenderRect(double x0, double y0, double x1, double y1);
...
/* Section 2 -- Elliptical arcs and rectangle*/
...
static void DisplayRect(double x0, double y0, double x1, double y1)
{
	...
	fy1 = Maxf(y0, y1);
//	MovePen(ix0, iy0);
	DisplayLine(fx0, fy0, fx1-fx0, 0);
	DisplayLine(fx1, fy0, 0, fy1-fy0);	
	DisplayLine(fx1, fy1, fx0-fx1, 0);
	DisplayLine(fx0, fy1, 0, fy0-fy1);
}
...
static void RenderRect(double x0, double y0, double x1, double y1)
{
    ...
    ix1 = ScaleX(x1);
    iy1 = ScaleY(y1);
    AddSegment(ix0, iy0, ix1, iy0);
    AddSegment(ix1, iy0, ix1, iy1);
    AddSegment(ix1, iy1, ix0, iy1);
    AddSegment(ix0, iy1, ix0, iy0);    
}
